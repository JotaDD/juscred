  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex justify-center items-center max-w-3xl gap-6">
        <Image
          className="hidden md:block lg:hidden xl:block fill-jc-dark-blue w-20 xl:w-[6.5rem]"
          src="/Idoc.svg"
          alt="doc search"
          width="110"
          height="90"
        />
        <div>
          <h3 className="text-jc-dark-blue font-bold text-xl md:text-3xl">
            Análise do crédito e formulação da proposta
          </h3>
          <p className="text-jc-dark-blue text-md md:text-xl">
      ...
      <div className="flex justify-center items-center max-w-3xl gap-6">
        <Image
          className="hidden md:block lg:hidden xl:block fill-jc-dark-blue w-20 xl:w-24 "
          src="/Icontrato.svg"
          alt="doc search"
          width="104"
          height="90"
